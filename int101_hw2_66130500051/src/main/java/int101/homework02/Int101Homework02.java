...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
        ...
        System.out.println(Utilitor.testString("Ochi"));
        System.out.println("<<<< 1.3 >>>>");
        System.out.println(Utilitor.computeIsbn10(974472362));
        System.out.println("<<<< 1.4 >>>>");
        System.out.println(Utilitor.testPositive(200.5));
    ...
    static void work02Person() {
        Person p1 = new Person("Naruedom", "Srirukkaew");
        Person p2 = new Person("Momkey", "God");
        Person p3 = new Person("Shark", "Loard");
        ...
        p2.setFirstname("Ohhhhhh");
        p2.setLastname("Mamameya");
    ...
    static void work03Account() {
        Person p1 = new Person("Naruedom", "Srirukkaew");
        Person p2 = new Person("Monkey", "God");
        Person p3 = new Person("Mamameya", "Hajime");
