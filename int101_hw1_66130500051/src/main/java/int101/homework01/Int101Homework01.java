...
import int101.homework01.work03.MyUtil;
...
public class Int101Homework01 {
    ...
    static void work01Question(boolean b1, boolean b2, boolean b3,
        ...
        // do nothing in this method; do your work in work01Answer()
    ...
    static void work02Question(int v1, int v2, int v3, int v4, int v5, int v6) {
        // do nothing in this method; do your work in work02Answer()
    ...
    static void work03UseOfUtilityClass() {
        ...
        System.out.println("calculateBMI = " + MyUtil.calculateBMI(2, 3));
        System.out.println("average = " + MyUtil.average(1, 2, 3));
    ...
    static void work04UseOfObjectClass() {
        ...
        BankAccount anotherAccount = new BankAccount(102, person2);

        account.deposit(1000);
        account.withdraw(200);
        account.transfer(300, anotherAccount);
        account.transfer(200, anotherAccount);
    
        

        System.out.println(account);
        System.out.println("Account Balance : " + account.getBalance() + " Bath");

        System.out.println(anotherAccount);
        System.out.println("Another account  Balance  : " + anotherAccount.getBalance() + " Bath");
